...
- CRUD Films
- CR*D Comments on films (no updating required)
- GET and display paginated lists of films
- Favorite films
- Follow other users
...
- Home page (URL: /#/ )
    - List of tags
    - List of films pulled from either Feed, Global, or by Tag
    - Pagination for list of films
- Sign in/Sign up pages (URL: /#/login, /#/register )
    - Use JWT (store the token in localStorage)
- Settings page (URL: /#/settings )
- Editor page to create/edit films (URL: /#/editor, /#/editor/film-slug-here )
- Film page (URL: /#/film/film-slug-here )
    - Delete film button (only shown to film's author)
    - Render markdown from server client side
    - Comments section at bottom of page
    - Delete comment button (only shown to comment's author)
- Profile page (URL: /#/@username, /#/@username/favorites )
    - Show basic user info
    - List of films populated from author's created films or author's favorited films
